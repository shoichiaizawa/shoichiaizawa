...
Tokyo, Japan · [LinkedIn](https://linkedin.com/in/shoichiaizawa) · [GitHub](https://github.com/shoichiaizawa)
...
- Co-led Cloud Ace's Claude Enterprise trial with Anthropic Japan: designed and ran trial mechanics, surveys, and retrospective sessions; trial completed, now supporting internal procurement.
- Built Cloud Ace's relationship with Aqua Voice from an internal mission: progressed from initial outreach to the Head of Growth, through a CEO-level Google Meet call, to hosting the CEO and Head of Growth at Cloud Ace's office during their first Japan visit (February 2026). Now engaged with the CRO on enterprise offering.
...
- Ran weekly 1-on-1s focused on mental health, career alignment, and conflict resolution to sustain performance through intensive systems-integration delivery cycles.
- Partnered with HR to scale the team: technical interviews, hiring calibration, and primary mentorship for new graduates entering their first commercial deployments.
...
- Provided enterprise technical advisory via Zendesk – diagnosed Google Cloud configuration issues and scoped practical workarounds.

## Education

**King's College London** – Studied Computer Science · 2010–2012

## Skills & Tooling

- **AI developer tools:** Devin Enterprise, Gemini Enterprise, Claude / Claude Code, Cursor, Aqua Voice, Codex
...
- Active member of AIDD, one of Japan's most active communities focused on AI-driven development. Topics span Devin, Claude Code, Codex, Cursor, and AI-driven product and project management. AIDD hosted two conferences in 2025.
- Also active in AIAU, AIDD's sibling community focused on the broader AI tooling ecosystem.
- Panel speaker, Azure OpenAI DevDay 2025 – joined as one of three AIDD-community guests on a panel facilitated by a GitHub Japan engineer.
- Talk on Devin Enterprise adoption at Cloud Ace, AIDD Devin/Windsurf community meetup, March 2026.
